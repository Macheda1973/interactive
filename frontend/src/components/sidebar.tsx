    ...
    (<div className={`absolute w-full h-[100vh] inset-0 bg-black bg-opacity-50 z-50`}>
      <div ref={connectRef} className={`absolute h-full w-[300px] bg-white dark:bg-black flex flex-col top-0 right-0 py-[50px] px-[18px] space-y-3`}>
        ...
        <div className="flex flex-col gap-1">
            <Link onClick={onClose} href="/" className={`flex p-2 px-5  rounded-lg dark:text-white ${pathname === "/" ? "bg-light-light dark:bg-gray-default": ""}`}>Affiliates</Link>
            <Link onClick={onClose} href="/partner" className={`flex p-2 px-5 rounded-lg dark:text-white  ${pathname === "/partner" ? "bg-light-light dark:bg-gray-default": ""}`}>Partner</Link>
            <Link onClick={onClose} href="/portals"className={`flex p-2 px-5 rounded-lg dark:text-white  ${pathname === "/portals" ? "bg-light-light dark:bg-gray-default": ""}`}>Portals</Link>
        </div>
